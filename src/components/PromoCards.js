...
const promos = [
    {
        ...
        description: "Take the guesswork out of gift-giving! Select your gift card value up to $100 and send it today or on a date of your choice.",
        img: images.rewards,
        btnText: 'Learn More',
        alt: ""
    },
            ...
            <div className='flex flex-col place-content-center justify-center lg:grid lg:grid-cols-2 my-24 mx-auto lg:w-800 gap-8'>
                {promos.map((promo) => (
                    <div
                        ...
                        key={promo.title}
                    >
                        <img src={promo.img} className="h-52 w-full object-cover rounded-t-3xl" alt={promo.alt} />
                        ...
                        <button className="my-7 mx-8 px-3 py-1 bg-black text-white text-lg rounded-full">
                            {promo.btnText}
                        </button>
                    </div>
                ))}
