        ...
        <div className="absolute flex flex-col top-0 bottom-0 left-0 right-0 justify-center items-start bg-black bg-opacity-10">
          <div>
            ...
            <div className="ml-5 mt-8 -mb-20 flex flex-row gap-3">
              <button className="bg-black text-white  font-semibold rounded-full px-3 py-2 border border-white">
                ORDER DELIVERY
              </button>
              <button className="bg-white text-black font-semibold rounded-full px-3 py-2">
                ORDER DELIVERY
              </button>
            </div>
          </div>
