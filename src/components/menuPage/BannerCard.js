...
const BannerCard = ({ cardDetails }) => {
	...
	return (
		<div className="rounded-3xl my-20 mx-5 md:mx-20 flex flex-col md:flex-row h-96 md:h-64">
			<div className="relative flex-1">
				<img
					...
					alt={image.imageName}
				/>
				{interestFlag.isDisplayed && (
					<div className="bg-red-600 absolute top-5 left-0 w-36">
						<p className="font-bold ml-1 text-white text-2xl uppercase tracking-tighter">
							{interestFlag.text}
						</p>
					</div>
				)}
