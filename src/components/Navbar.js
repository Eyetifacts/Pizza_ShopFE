...
const Navbar = () => {
  return (
    <div className="flex flex-row items-center gap-3 text-xl lg:text-2xl h-12 lg:h-20 items-center">
      ...
      <button className="lg:hidden flex rounded-full bg-black text-white font-semibold text-base px-3 py-1 mr-1 uppercase">LOG IN</button>
